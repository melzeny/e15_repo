...
void TIMER2_init(void)
{
	...
	/*set OC2 pin mode*/
		...
		(TIMER2_MODE_TYPE_SELECTOR_msk == TIMER2_MODE_NORMAL_msk)
	TCCR2 &= TIMER2_NON_PWM_OC2_clr_msk;
	TCCR2 |= TIMER2_OC2_PIN_MODE_NON_PWM;

#elif (TIMER2_MODE_TYPE_SELECTOR_msk == TIMER2_MODE_PHASE_CORRECT_msk) || \
		(TIMER2_MODE_TYPE_SELECTOR_msk == TIMER2_MODE_FAST_PWM_msk)
	TCCR2 &= TIMER2_PWM_OC2_clr_msk;
	TCCR2 |= TIMER2_OC2_PIN_MODE_PWM;
#endif
	/*set Steps to count */
